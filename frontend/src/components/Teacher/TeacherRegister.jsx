    ...
    <div className="flex h-screen w-full">
      <div className="h-screen w-1/2">
        <img
          ...
          src="https://images.pexels.com/photos/33485108/pexels-photo-33485108.jpeg"
              ...
              >
                <p class="flex items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
                 Already have an account ? 
                   <Link to="/teacher/loginTeacher" class="font-semibold transition-colors hover:text-pink-900 text-pink-600">
                   Login Here
                  </Link>
                </p>
              </label>
